function varargout = circ_3(varargin)
% CIRC_3 MATLAB code for circ_3.fig
%      CIRC_3, by itself, creates a new CIRC_3 or raises the existing
%      singleton*.
%
%      H = CIRC_3 returns the handle to a new CIRC_3 or the handle to
%      the existing singleton*.
%
%      CIRC_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CIRC_3.M with the given input arguments.
%
%      CIRC_3('Property','Value',...) creates a new CIRC_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before circ_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to circ_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help circ_3

% Last Modified by GUIDE v2.5 11-Jul-2021 01:03:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @circ_3_OpeningFcn, ...
                   'gui_OutputFcn',  @circ_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before circ_3 is made visible.
function circ_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to circ_3 (see VARARGIN)
...
% Choose default command line output for circ_3
handles.output = hObject;
set(gcf, 'units','normalized','outerposition',[0 0 1 1]);
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes circ_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = circ_3_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit16,'String',num2str(d2,'%6.2f'));
% addlistener(handles.slider1,'Value','PostSet',@(s,e) set(handles.edit1,'String',num2str(get(handles.slider1,'Value'),'%6.1f')));
...
met3 = 0.59;
 ...
 text(0.1+met1, 0.9, 'h_1 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met1, 0.9, hm  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met1, 0.9, 'm' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met1, 0.7, 'd_1 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met1, 0.7, dm  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met1, 0.7, 'm' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met1, 0.1, 'Q_1 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met1, 0.1, Qm  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met1, 0.1, 'pC' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met1, 0.5, 'C_1 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met1, 0.5, Cm  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met1, 0.5, 'pF' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met1, 0.3, 'V_1 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met1, 0.3, Vm  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met1, 0.3, 'V' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met2, 0.9, 'h_2 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met2, 0.9, hn  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met2, 0.9, 'm' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')

 text(0.1+met2, 0.7, 'd_2 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met2, 0.7, dn  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met2, 0.7, 'm' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met2, 0.1, 'Q_2 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met2, 0.1, Qn  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met2, 0.1, 'pC' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met2, 0.5, 'C_2 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met2, 0.5, Cn  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met2, 0.5, 'pF' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met2, 0.3, 'V_2 =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met2, 0.3, Vn  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.23+met2, 0.3, 'V' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met3, 0.1, 'Q =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met3, 0.1, Qp  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.25+met3, 0.1, 'pC' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met3, 0.5, 'C =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met3, 0.5, Cp  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.25+met3, 0.5, 'pF' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 
 text(0.1+met3, 0.3, 'V =' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
 text(0.16+met3, 0.3, Vp  , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'r')
 text(0.25+met3, 0.3, 'V' , 'FontUnits','normalized','FontSize',0.11,'FontName', 'Unicode', 'Color', 'k')
...
vel1_x=(vel_x10+0.5+(d1/2))*synt_E;
vel2_x=(vel_x20+0.5+(d2/2))*synt_E;
...
text(0.53+0.5*d2 ,h2/4+0.21, '+', 'FontUnits','normalized','FontSize',0.05,'FontName', 'Unicode', 'Color', 'r') 
text(0.53+0.5*d2 ,h2/2+0.21, '+', 'FontUnits','normalized','FontSize',0.05,'FontName', 'Unicode', 'Color', 'r')
text(0.53+0.5*d2 ,-h2/2+0.21, '+', 'FontUnits','normalized','FontSize',0.05,'FontName', 'Unicode', 'Color', 'r')
text(0.53+0.5*d2 ,-h2/4+0.21, '+', 'FontUnits','normalized','FontSize',0.05,'FontName', 'Unicode', 'Color', 'r')
 
text(0.45-0.5*d1 ,h1/4+1, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d1 ,h1/2+1, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d1 ,-h1/2+1.06, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d1 ,-h1/4+1.06, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')

text(0.45-0.5*d2 ,h2/4+0.21, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d2 ,h2/2+0.21, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d2 ,-h2/2+0.21, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
text(0.45-0.5*d2 ,-h2/4+0.21, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')

text(0.46+0.5*d1 ,h1/2+1.07, '+Q_1', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'r')
text(0.46+0.5*d2 ,h2/2+0.28, '+Q_2', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'r')
text(0.46-0.5*d1 ,h1/2+1.07, '-Q_1', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'r')
text(0.46-0.5*d2 ,h2/2+0.28, '-Q_2', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'r')
   
text(0.48 ,-0.8, 'V', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'r')
text(0.48+L_batt/2+0.02 ,-h_arnitikou, '+', 'FontUnits','normalized','FontSize',0.05,'FontName', 'Unicode', 'Color', 'r')
text(0.48-L_batt/2-0.01 ,-h_arnitikou, '-', 'FontUnits','normalized','FontSize',0.08,'FontName', 'Unicode', 'Color', 'r')
...
if synt_d==1
text(h1_x(1)-0.05 ,1.1, 'h_1', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'k')
text(h2_x(1)-0.05 ,0.28, 'h_2', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'k')

text((d1_x(1)+d1_x(2))/2-0.02 ,d1_y(2)-0.05, 'd_1', 'FontUnits','normalized','FontSize',0.04,'FontName', 'Unicode', 'Color', 'k')
